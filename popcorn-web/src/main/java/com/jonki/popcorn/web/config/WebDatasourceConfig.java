...
import com.jonki.popcorn.web.config.properties.EclipseLinkProperties;
import com.jonki.popcorn.web.config.properties.EntityManagerProperties;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.jonki.popcorn.core.jpa.repository")
@EntityScan(basePackages = "com.jonki.popcorn.core.jpa.entity")
