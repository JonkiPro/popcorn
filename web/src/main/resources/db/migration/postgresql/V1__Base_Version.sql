...
CREATE TABLE users_received_invitations (user_invited_id BIGINT NOT NULL, user_id BIGINT NOT NULL, PRIMARY KEY (user_invited_id, user_id));
CREATE TABLE users_sent_invitations (user_id BIGINT NOT NULL, user_invited_id BIGINT NOT NULL, PRIMARY KEY (user_id, user_invited_id));
...
CREATE SEQUENCE movieSequenceGenerator INCREMENT BY 50 START WITH 50;
CREATE SEQUENCE contributionSequenceGenerator INCREMENT BY 50 START WITH 50;
CREATE SEQUENCE movieInfoSequenceGenerator INCREMENT BY 50 START WITH 50;
